...
function Relief() {
  return (
    <div className="relief-container">
      ...
      <h1>  <i class="fas fa-hands-helping"></i> Request for Relief Assistance</h1>
      <div className='TextImg'>
        <div className="description">
          <p>
            If you have recently experienced a disaster, we are here to assist you. Please fill out the form by clicking on "Proceed" button and submit your information. Provide details about your situation and attach images, helping us better understand the impact on your location or home.
          </p>
          <p>
